...
https_proxy=http://proxy.dbg.westfield.com:8080 curl -H "x-api-key:fcb397795639d33ca285aff6ce91844bcd9ed68dcca2a7f" -d "deployment[app_name]=$app_name" -d "deployment[description]=RPM deployment (@Leon @Chris @Craig @Alec)" -d "deployment[revision]=%{version}" -d "deployment[user]=`hostname -s`"  https://rpm.newrelic.com/deployments.xml
...
- Add GA hook to store hours toggle button when it's collapsed
  (cpearce@au.westfield.com)
- Adding a GA hook to track the link to email a centre
  (cpearce@au.westfield.com)
- Adding GA hooks to track social share outbound and email links
  (cpearce@au.westfield.com)
- Adding GA hooks to track links to call a store (cpearce@au.westfield.com)
- Adding GA hook to track viewing store map (cpearce@au.westfield.com)
- Adding GA hooks to track links that go to storefront
  (cpearce@au.westfield.com)

* Tue May 27 2014 ci <doperations@au.westfield.com> 0.2.397-1
- 
...
* Thu May 22 2014 ci <doperations@au.westfield.com> 0.2.390-1
- 
...
- added comments and reordered into related sections
  (bpritchard@au.westfield.com)
- better fix for rake tasks outside of test/dev (bpritchard@au.westfield.com)
- renamed variable (bpritchard@au.westfield.com)
- Extended SEO testing (bpritchard@au.westfield.com)
...
* Mon Apr 14 2014 ci <doperations@au.westfield.com> 0.2.289-1
- 

* Mon Apr 14 2014 ci <doperations@au.westfield.com> 0.2.288-1
- 

* Mon Apr 14 2014 ci <doperations@au.westfield.com> 0.2.287-1
- 

* Mon Apr 14 2014 ci <doperations@au.westfield.com> 0.2.286-1
- 
...
- Merge pull request #1066 from jlambert/centre-service-hotfix
  (jlambert@au.westfield.com)
- remove centre services (jlambert@au.westfield.com)

* Fri Apr 11 2014 ci <doperations@au.westfield.com> 0.2.280-1
- re-add store categories with correct url (jlambert@au.westfield.com)

* Fri Apr 11 2014 ci <doperations@au.westfield.com> 0.2.279-1
- 
...
- Merge pull request #1047 from araeside/fix-stores-maps-navigation
  (araeside@au.westfield.com)
- show store list when going from storefront map view to stores page
  (alec@smartalecwebsites.com.au)
...
* Tue Apr 01 2014 ci <doperations@au.westfield.com> 0.2.253-1
- Revert "Merge pull request #1007 from ewee/remove_store_hours"
  (craigm.smith@au.westfield.com)
...
- Merge pull request #1015 from araeside/search-results-page
  (chorn@au.westfield.com)
- add tests for search helpers (alec@smartalecwebsites.com.au)

* Wed Mar 26 2014 ci <doperations@au.westfield.com> 0.2.242-1
- Merge pull request #1021 from mmancuso/master (ldewey@au.westfield.com)
- fixing sitemap cron (mmancuso@au.westfield.com)

* Wed Mar 26 2014 ci <doperations@au.westfield.com> 0.2.241-1
- Merge pull request #1020 from mbamford/feature/curations
  (craigM.smith@au.westfield.com)
- Added CurationController#show slug and centre_id params
  (michael@michaelbamford.com)
...
* Wed Mar 12 2014 ci <doperations@au.westfield.com> 0.2.213-1
- Final updates to Privacy Policy (cpearce@au.westfield.com)

* Wed Mar 12 2014 ci <doperations@au.westfield.com> 0.2.212-1
- Merge pull request #988 from cpearce/quick-fixes (chorn@au.westfield.com)
- Updating Privacy Policy page - WSF-6373 (cpearce@au.westfield.com)
...
- Merge pull request #962 from araeside/fix-search-suggestion-links
  (chorn@au.westfield.com)
- Dont close search suggestions on input blur, only close them when clicking
  outside the suggestions (alec@smartalecwebsites.com.au)
- add target=_self to link in search suggestions to stop angular from hijacking
  them (alec@smartalecwebsites.com.au)

* Wed Mar 05 2014 ci <doperations@au.westfield.com> 0.2.191-1
- Merge pull request #964 from csmith/master (craigM.smith@au.westfield.com)
- WSF-6116 fixed closed bug on store page (craigm.smith@au.westfield.com)
...
* Wed Mar 05 2014 ci <doperations@au.westfield.com> 0.2.187-1
- DealsController#show checks Deal#published?, not #available_to
  (michael@michaelbamford.com)

* Mon Mar 03 2014 ci <doperations@au.westfield.com> 0.2.186-1
- 
...
- Making content for name more generic for better reuse on tile layout
  (cpearce@au.westfield.com)
- Smoke test update (ldewey@au.westfield.com)
- Making date range code more readable for events helper
  (cpearce@au.westfield.com)
- Applying Microdata to movies pages - WSF-6198 (cpearce@au.westfield.com)
- Cleaning up Microdata - WSF-6198 (cpearce@au.westfield.com)
